...
function move(){
  if(keyWentDown(UP_ARROW) || mousePressedOver(up)){
    player.velocityY = -8;
    player.velocityX = 0;
  }else{
    player.velocityY = 0;
  }
  if(keyWentDown(DOWN_ARROW) || mousePressedOver(down)){
    player.velocityY = 8;
    player.velocityX = 0;
  }
  if(keyWentDown(LEFT_ARROW) || mousePressedOver(right)){
    player.velocityX = -8;
    player.velocityY = 0;
  }else{
    player.velocityX = 0;
  }
  if(keyWentDown(RIGHT_ARROW) || mousePressedOver(left)){
    player.velocityX = 8;
    player.velocityY = 0;
  }
